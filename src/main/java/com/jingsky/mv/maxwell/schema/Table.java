...
import com.jingsky.mv.maxwell.schema.columndef.BigIntColumnDef;
import com.jingsky.mv.maxwell.schema.columndef.ColumnDef;
import com.jingsky.mv.maxwell.schema.columndef.EnumeratedColumnDef;
import com.jingsky.mv.maxwell.schema.columndef.IntColumnDef;
import com.jingsky.mv.maxwell.schema.ddl.ColumnPosition;
import com.jingsky.mv.maxwell.schema.ddl.DeferredPositionUpdate;
...
public class Table {
	...
	private synchronized List<String> normalizedColumnNames() {
		/*
		   ...
		   we do this normalization lazily, as when a TableBootstrap object is being deserialized
